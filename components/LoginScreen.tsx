...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Footer */}
      <div className="fixed bottom-0 left-0 right-0 bg-white py-4 px-4 flex items-center justify-center z-40 border-t border-gray-200">
        <div className="flex flex-col items-center gap-3">
          <div className="flex items-center gap-2 text-gray-700">
            <span className="text-2xl">👤</span>
            <span className="text-sm">Aplicativo desenvolvido pelo 2º Ten Thiago Santos</span>
          </div>
          <a
            href="https://wa.me/5521967586628"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg flex items-center gap-2 transition-colors font-medium"
          >
